...
#-------------------------------------------------------------------------------
delta = 0.01 #(мм). Максимально допустимая разница координат центров концентрическтих окружностей (если  разница координат больше этой величины, окружности не считаются концентрическими)
