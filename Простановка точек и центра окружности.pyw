...
##    if Centre_var: # если простановка обозначений центров включена
...
##    if Point_var: # если простановка точек включена
...
##    if Conditional_sign_var: # если простановка условных знаков включена
        ...
        for text in [(Centre_var, text_Centre), (Point_var, text_Point), (Conditional_sign_var, text_Conditional_sign)]:
            if text[0]:
                if msg != "":
                    msg = msg + "\n"
                msg = msg + text[1]
