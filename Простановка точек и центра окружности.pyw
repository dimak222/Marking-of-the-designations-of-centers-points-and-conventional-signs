...
def Creating(): # создание центров и точек
    ...
    if Centre_var: # ставить ли обозначения центров
        ...
        if Centre_repeat == False: # если повторные значения не нужны
            list_Obg_for_Centre = Сhecking_duplicates(list_Obg.copy(), list_Centre) # проверка на повторные обозначения центров/точек (из перевого списка вычитаем объекты второго)
        else:
    ...
    if Point_var: # ставить ли точки
        ...
        if Point_repeat == False: # если повторные значения не нужны
            list_Obg_for_Point = Сhecking_duplicates(list_Obg.copy(), list_Point) # проверка на повторные обозначения центров/точек (из перевого списка вычитаем объекты второго)
        else:
